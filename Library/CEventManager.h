...
class CGameEventManager
{
	...
	virtual void RemoveListener(CGameEventListener2 *listener) = 0; // 6
	virtual CGameEvent* CreateEvent(const char* name, bool force = false, int *cookie = nullptr) = 0; // 7
	virtual bool FireEvent(CGameEvent *event, bool dontBroadcast) = 0; // 8
	virtual bool FireEventClientSide(CGameEvent *event) = 0; // 9
