...
{
public:
	virtual void other_offset() = 0;
	virtual int idk_what_this_is() = 0;
	virtual float C_DOTA_BaseNPC__GetZChangeSpeed(void) = 0; // 304
	...
	virtual float C_DOTA_BaseNPC__GetHealthRegen(void) = 0; // 309
	virtual float GetMana(void) = 0;
	virtual float GetMaxMana(void) = 0;
	virtual float C_DOTA_BaseNPC__GetManaRegen(void) = 0;
	...
	virtual bool C_DOTA_BaseNPC__IsRoshan(void) = 0; //no
	...
	virtual void C_DOTA_BaseNPC__OverrideSelectionPriority(int priority) = 0; // eh
	...
	virtual int C_DOTA_BaseNPC__GetDamageMin(void) = 0; // correct
	virtual int C_DOTA_BaseNPC__GetDamageMax(void) = 0; // correct
	virtual float C_DOTA_BaseNPC__GetDamageBonus(void) = 0;
	virtual bool C_DOTA_BaseNPC__IsRooted(void) = 0;
	virtual void ok_sub_2ED6A30() = 0;
	virtual void ok_sub_2EDBCA0() = 0;
	...
	virtual CDotaPlayer* GetPlayerOwner(void) = 0;
	virtual int GetPlayerOwnerID(void) = 0;
	...
	virtual void* C_DOTA_BaseNPC__GetUnitColor(void) = 0;
