...
public:
	...
	virtual int n_327(); // 327, 
	virtual float n_328(); // 328,  
	virtual void IsValidAbilityToCast(); // 329, 
	virtual bool IsDemon(); // 330, 
	virtual bool IsRoshan(); // 331, 
	virtual void ShouldForwardPurchaseRequest(); // 332, 
	virtual void IsZombie(); // 333, 
	virtual void GetPortraitActivityModifier(); // 334, 
	virtual void CanAcceptTargetToAttack(); // 335, 
	...
	virtual void ShouldPerformLean(); // 406, 
	virtual void UsesConstantGesture(); // 407, 
	virtual void GetConstantGestureWeight(); // 408, 
	virtual void GetConstantGestureCycle(); // 409, 
	virtual void GestureCycleComplete(); // 410, 
	virtual void ParsePortraitInfo(); // 411, #STR: ".vmdl", "default", "-herorecorder"
	virtual CDotaPlayer* GetPlayerOwner(); // 412, 
	virtual int GetPlayerOwnerID(); // 413, 
	virtual void HasModifiedAbilityParticleName(); // 414, 
	virtual void GetModifiedAbilityParticleName(); // 415, 
	virtual void GetVoiceFile(); // 416, 
